package com.github.disparter.msstudy.config;
...
public class CacheConfiguration implements DisposableBean {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("msstudy");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("msstudy");
        ...
        config.getMapConfigs().put("com.github.disparter.msstudy.domain.*", initializeDomainMapConfig(jHipsterProperties));
